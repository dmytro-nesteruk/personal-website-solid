...
const meta = {
	title: "Education | Dmytro Nesteruk",
	description:
	...
	canonical: `${import.meta.env.VITE_APP_BASE_URL}${routerBook.about.children.education.path}`,
	og: {
...
const Bio = () => (
	<>
		...
		<section>
			<h1 class="text-light-grey">education</h1>
		</section>
	</>
);
